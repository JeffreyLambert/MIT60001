...
def get_guessed_word(secret_word, letters_guessed):
    ...
    '''
    # FILL IN YOUR CODE HERE AND DELETE "pass"
    output_list = list(secret_word)
    for i in range(len(secret_word)):
        if output_list[i] in letters_guessed:
            pass
        else:
            output_list[i] = '_'
    ...
    while guesses_left > 0:
        ...
        while warnings_left > 0:
            if not guess.isalpha():
                ...
                warnings_left -= 1
                guess = input(f"That's not a single letter!  You have {warnings_left} warnings left. Please guess a single letter: ")
